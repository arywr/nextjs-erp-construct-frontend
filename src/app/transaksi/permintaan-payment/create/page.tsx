...
export default function CreatePermintaanPaymentPage() {
  const [showConfirmDialog, setShowConfirmDialog] = React.useState(false)
  const [formData, setFormData] = React.useState({
    idPermintaanPayment: "",
    po: "",
    rekeningSumberBankName: "",
    rekeningSumberAccountNumber: "",
    rekeningSumberAccountOwner: "",
    rekeningTujuanBankName: "",
    rekeningTujuanAccountNumber: "",
    rekeningTujuanAccountOwner: "",
  })
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <h1 className="text-2xl font-semibold tracking-tight">Tambah Permintaan Payment</h1>
                    <p className="text-sm text-muted-foreground">
                      Buat permintaan pembayaran baru. Lengkapi semua informasi yang diperlukan untuk mencatat permintaan pembayaran purchase order.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end gap-4 pt-4 border-t">
                    <Button type="button" variant="outline" asChild>
                      <Link href="/transaksi/permintaan-payment">Batal</Link>
                    </Button>
        ...
        <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Apakah Anda yakin ingin menyimpan data permintaan payment ini? Pastikan semua informasi sudah benar sebelum menyimpan.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
