...
const sampleData: BarangMasuk[] = [
  ...
  },
  {
    ...
    jumlah: 500,
    keterangan: "Besi beton untuk struktur gedung",
    tanggal: "2024-01-16",
  },
  {
    id: "BM-2024-003",
    ...
    jumlah: 20,
    keterangan: "Pasir untuk produksi paving block",
    tanggal: "2024-01-17",
  },
  {
    id: "BM-2024-004",
  ...
  },
  {
    ...
    jumlah: 150,
    keterangan: "Semen untuk produksi tiang pancang",
    tanggal: "2024-01-21",
  },
  {
    id: "BM-2024-008",
...
export default function BarangMasukPage() {
  ...
  const [selectedBarangMasuk, setSelectedBarangMasuk] = React.useState<BarangMasuk | null>(null)
  ...
  const filteredData = sampleData.filter((barangMasuk) => {
    const query = searchQuery.toLowerCase()
    return (
      barangMasuk.id.toLowerCase().includes(query) ||
      barangMasuk.namaBarang.toLowerCase().includes(query) ||
      barangMasuk.produksi.nomorProduksi.toLowerCase().includes(query) ||
      barangMasuk.produksi.namaProduksi.toLowerCase().includes(query) ||
      formatDate(barangMasuk.tanggal).toLowerCase().includes(query)
    )
  })
  ...
  const handleDeleteConfirm = () => {
    ...
    console.log("Deleting barang masuk:", selectedBarangMasuk?.id)
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Kelola transaksi barang masuk ke gudang. Catat semua barang yang masuk dan kaitkan dengan produksi terkait.
                </p>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  <Button asChild>
                    <Link href="/transaksi/barang-masuk/create">
              ...
              <div className="rounded-lg border border-border bg-card">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead>ID Transaksi Barang Masuk</TableHead>
                  ...
                  <TableBody>
                    {paginatedData.length > 0 ? (
                      paginatedData.map((barangMasuk) => (
                        <TableRow key={barangMasuk.id}>
                          <TableCell className="font-medium">{barangMasuk.id}</TableCell>
                          <TableCell>{formatDate(barangMasuk.tanggal)}</TableCell>
                          <TableCell>{barangMasuk.namaBarang}</TableCell>
                          <TableCell>
                            <div className="flex items-center gap-2">
                              <Badge variant="outline" className="text-xs">
                                {barangMasuk.produksi.nomorProduksi}
                              </Badge>
                              <span className="text-sm text-muted-foreground">
                                {barangMasuk.produksi.namaProduksi}
                              </span>
                            </div>
                          </TableCell>
                          <TableCell className="text-right">
                            {barangMasuk.jumlah.toLocaleString("id-ID")}
                          </TableCell>
                          ...
                          <TableCell className="text-right">
                            <div className="flex items-center justify-end gap-2">
                              <Button
                                ...
                                asChild
                              >
                                <Link href={`/transaksi/barang-masuk/${barangMasuk.id}`}>
                              ...
                              <Button
                                ...
                                asChild
                              >
                                <Link href={`/transaksi/barang-masuk/${barangMasuk.id}/edit`}>
        ...
        <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Apakah Anda yakin ingin menghapus transaksi <strong>{selectedBarangMasuk?.id}</strong>? 
