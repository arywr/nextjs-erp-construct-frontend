...
export default function EditPurchaseOrderPage() {
  ...
  const [formData, setFormData] = React.useState({
    idPO: (params.id as string) || "PO-2024-001",
    tanggalPO: "2024-01-15",
    supplier: "SUP001",
    dataType: "Permintaan Barang" as "Permintaan Barang" | "Data Barang",
    permintaanBarang: "PB-2024-001",
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-4">
                  <Button variant="ghost" size="icon" asChild>
                    <Link href={`/transaksi/purchase-order/${params.id}`}>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Ubah informasi purchase order yang ada. Pastikan semua data yang diubah sudah benar sebelum menyimpan.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end gap-4 pt-4 border-t">
                    <Button type="button" variant="outline" asChild>
                      <Link href={`/transaksi/purchase-order/${params.id}`}>Batal</Link>
                    </Button>
        ...
        <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Apakah Anda yakin ingin menyimpan perubahan data purchase order ini? Pastikan semua informasi sudah benar sebelum menyimpan.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
