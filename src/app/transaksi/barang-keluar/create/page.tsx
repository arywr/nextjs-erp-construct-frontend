...
export default function CreateBarangKeluarPage() {
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <h1 className="text-2xl font-semibold tracking-tight">Tambah Barang Keluar</h1>
                    <p className="text-sm text-muted-foreground">
                      Buat transaksi barang keluar baru. Lengkapi semua informasi yang diperlukan untuk mencatat barang keluar dari gudang.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end gap-4 pt-4 border-t">
                    <Button type="button" variant="outline" asChild>
                      <Link href="/transaksi/barang-keluar">Batal</Link>
                    </Button>
        ...
        <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Apakah Anda yakin ingin menyimpan data transaksi barang keluar ini? Pastikan semua informasi sudah benar sebelum menyimpan.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
