...
const sampleData: Supplier[] = [
  ...
  {
    id: "SUP002",
    namaSupplier: "CV Semen Nusantara",
    kontak: "081234567891",
    alamat: "Jl. Perintis Kemerdekaan No. 200",
    kota: "Bandung",
  },
  {
    id: "SUP003",
    namaSupplier: "PT Besi Beton Indonesia",
    kontak: "081234567892",
    alamat: "Jl. Gatot Subroto No. 300",
    kota: "Jakarta",
  },
  {
    id: "SUP004",
    namaSupplier: "UD Perkakas Jaya",
    kontak: "081234567893",
    alamat: "Jl. Ahmad Yani No. 400",
    kota: "Surabaya",
  },
  {
    id: "SUP005",
    namaSupplier: "PT Cat Tembok Nusantara",
    kontak: "081234567894",
  ...
  {
    id: "SUP006",
    namaSupplier: "CV Keramik Indah",
    kontak: "081234567895",
    alamat: "Jl. Diponegoro No. 600",
    kota: "Semarang",
  },
]
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Kelola data supplier yang tersedia dalam sistem. Anda dapat menambah, mengedit, dan menghapus informasi supplier.
                </p>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <Button asChild>
                  <Link href="/master/supplier/create">
