              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <h1 className="text-2xl font-semibold tracking-tight">Tambah Barang Baru</h1>
                    <p className="text-sm text-muted-foreground">
                      Tambahkan data barang baru ke dalam sistem. Lengkapi semua informasi yang diperlukan untuk menambahkan barang.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end gap-4 pt-4 border-t">
                    <Button type="button" variant="outline" asChild>
                      <Link href="/master/barang">Batal</Link>
                    </Button>
        ...
        <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Apakah Anda yakin ingin menyimpan data barang ini? Pastikan semua informasi sudah benar sebelum menyimpan.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
